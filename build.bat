...
cl /Zi /EHsc /I ..\src /I ..\src\Render /I ..\examples\Pong\Render ..\examples\Pong\PongMain.cpp ..\examples\Pong\Table.cpp ..\examples\Pong\Ball.cpp ..\examples\Pong\Paddle.cpp ..\examples\Pong\Render\PaddleDrawable.cpp /link engine.lib Render2D.lib
popd
