...
cl /Zi /LD /EHsc /I ..\src\Render /I ..\examples\Tetris ..\src\Render\Render2D.cpp ..\src\Render\Drawable2D.cpp ..\src\Render\TextDrawable.cpp ..\examples\Tetris\Render\BlockDrawable.cpp
